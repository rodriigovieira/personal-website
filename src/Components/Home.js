...
export default class Home extends Component {
  renderPortuguese = () => {
    return (
      <div>
        <ul>
          <li><a href="https://clone.rodrigovieira.work">Twitter Clone</a> - Aplicativo Fullstack com NodeJS, React e React Native. Clone do Twitter.</li>
          ...
          <li><a href="https://schedule.rodrigovieira.work">Schedule Manager</a> - Aplicativo em NodeJS seguindo o padrão RESTFUL para gerenciamento de horários de uma empresa. Não apresenta interface gráfica.</li>
          <li><a href="https://todo.rodrigovieira.work">Todo APP</a> - Aplicativo em NodeJS seguindo o padrão RESTFUL para gerenciamento de tarefas. Não apresenta interface gráfica.</li>
        </ul>
      </div>
    )
  }
    ...
    return (
      <div>
        <ul>
          ...
          <li><a href="https://schedule.rodrigovieira.work">Schedule Manager</a> - NodeJS app, following the RESTFUL standard, made to help manage the schedule of a company. No UI available.</li>
          <li><a href="https://todo.rodrigovieira.work">Todo APP</a> - NodeJS RESTFUL app made to manage Todos. No UI available.</li>
        </ul>
      </div>
    )
  }
